...
CellType.All = {
    'water': CellType(b'~', Colors.white, Colors.dark_blue, water),
    'grass': CellType(b'.', Colors.white, Colors.darker_green, grass),
    'tree': CellType(b'{', Colors.white, Colors.darker_green, tree),
    'mountain': CellType(b'^', Colors.white, Colors.darker_green, mountain),
}
